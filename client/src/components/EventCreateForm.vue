<template>
  <b-form @submit="onSubmit" @reset="onReset" v-if="show">
    <b-form-group id="input-group-1" label="Event Name:" label-for="input-1">
      <b-form-input id="input-1" v-model="form.eventName" required placeholder="Enter event name"></b-form-input>
    </b-form-group>
    ...
    <b-form-group id="input-group-2" label="Attendee Limit:" label-for="input-2">
      ...
      >Events must have at least 2 people attending, including you</b-form-invalid-feedback>
    </b-form-group>
